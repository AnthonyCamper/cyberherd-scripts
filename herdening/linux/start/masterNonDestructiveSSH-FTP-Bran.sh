...
############################## BACKUP /etc
sudo tar -czvf /backup/initial/etc.tar.gz /etc

############################## BACKUP /var/www
sudo tar -czvf /backup/initial/www.tar.gz /var/www

############################## BACKUP /home
sudo tar -czvf /backup/initial/home.tar.gz /home

############################## BACKUP /bin
sudo tar -czvf /backup/initial/bin.tar.gz /bin

############################## BACKUP /usr/bin
sudo tar -czvf /backup/initial/usr_bin.tar.gz /usr/bin
